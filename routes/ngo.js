...
const { getNgos, getparticularNgo, addEvent, createNgo, addVolunteer, editNgo, getNgoEvents, renderEventPage, renderCreateEventPage, renderEditEventPage, addImage, removeImage, updateEvent } = require("../controllers/ngo");
